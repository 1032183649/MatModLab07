...
следующим уравнением:  
  1. $\frac{\partial n}{\partial t} = (0.66+0.00006*n(t))(N-n(t))$  
  2. $\frac{\partial n}{\partial t} = (0.000066+0.6*n(t))(N-n(t))$  
  3. $\frac{\partial n}{\partial t} = (0.66*t+0.6*t*n(t))(N-n(t))$  

  При этом объем аудитории N = 2010, в начальный момент о товаре знает 29 человек. Для
...
![Рис. 1. График для 1 слусая](image/1.png){ #fig:002 width=70% }  
...
![Рис. 2. График для 2 случая](image/2.png){ #fig:003 width=70% }
